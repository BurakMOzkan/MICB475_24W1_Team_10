...
p1 <- ggplot(volcano_data, aes(x = logFC, y = logP, color = Significant)) +
...
ggsave("Family_Older_Smokers_HealthypMS.png", plot = p1, width = 6, height = 4, dpi = 300)
...
p2 <- ggplot(volcano_data, aes(x = logFC, y = logP, color = Significant)) +
  geom_point(alpha = 0.6, size = 2) +
  scale_color_manual(values = c("grey", "red")) +
  geom_hline(yintercept = -log10(0.05), linetype = "dashed", color = "red") +
  geom_vline(xintercept = 1, linetype = "dashed", color = "red") +
...
ggsave("Family_Older_NonSmokers_HealthypMS.png", plot = p2, width = 6, height = 4, dpi = 300)
...
p3 <- ggplot(volcano_data, aes(x = logFC, y = logP, color = Significant)) +
  geom_point(alpha = 0.6, size = 2) +
  scale_color_manual(values = c("grey", "red")) +
  geom_hline(yintercept = -log10(0.05), linetype = "dashed", color = "red") +
  geom_vline(xintercept = 1, linetype = "dashed", color = "red") +
...
ggsave("Family_Younger_NonSmokers_HealthypMS.png", plot = p3, width = 6, height = 4, dpi = 300)
...
p4 <- ggplot(volcano_data, aes(x = logFC, y = logP, color = Significant)) +
  geom_point(alpha = 0.6, size = 2) +
  scale_color_manual(values = c("grey", "red")) +
  geom_hline(yintercept = -log10(0.05), linetype = "dashed", color = "red") +
  geom_vline(xintercept = 1, linetype = "dashed", color = "red") +
...
ggsave("Family_Younger_Smokers_HealthypMS.png", plot = p4, width = 6, height = 4, dpi = 300)
...
p5 <- ggplot(volcano_data, aes(x = logFC, y = logP, color = Significant)) +
  geom_point(alpha = 0.6, size = 2) +
  scale_color_manual(values = c("grey", "red")) +
  geom_hline(yintercept = -log10(0.05), linetype = "dashed", color = "red") +
  geom_vline(xintercept = 1, linetype = "dashed", color = "red") +
...
ggsave("Genus_Older_Smokers_HealthypMS.png", plot = p5, width = 6, height = 4, dpi = 300)
...
p6 <- ggplot(volcano_data, aes(x = logFC, y = logP, color = Significant)) +
  geom_point(alpha = 0.6, size = 2) +
  scale_color_manual(values = c("grey", "red")) +
  geom_hline(yintercept = -log10(0.05), linetype = "dashed", color = "red") +
  geom_vline(xintercept = 1, linetype = "dashed", color = "red") +
...
ggsave("Genus_Older_NonSmokers_HealthypMS.png", plot = p6, width = 6, height = 4, dpi = 300)

###############################################################################
################## Younger Smoker Healthy v. pMS ################################
###############################################################################
...
p7 <- ggplot(volcano_data, aes(x = logFC, y = logP, color = Significant)) +
  geom_point(alpha = 0.6, size = 2) +
  scale_color_manual(values = c("grey", "red")) +
  geom_hline(yintercept = -log10(0.05), linetype = "dashed", color = "red") +
  geom_vline(xintercept = 1, linetype = "dashed", color = "red") +
...
ggsave("Genus_Younger_Smokers_HealthypMS.png", plot = p7, width = 6, height = 4, dpi = 300)
...
p8 <- ggplot(volcano_data, aes(x = logFC, y = logP, color = Significant)) +
  geom_point(alpha = 0.6, size = 2) +
  scale_color_manual(values = c("grey", "red")) +
  geom_hline(yintercept = -log10(0.05), linetype = "dashed", color = "red") +
  geom_vline(xintercept = 1, linetype = "dashed", color = "red") +
...
ggsave("Genus_Younger_NonSmokers_HealthypMS.png", plot = p8, width = 6, height = 4, dpi = 300)